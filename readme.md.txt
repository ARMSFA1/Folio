...
<p>**Engaged** The group by suggesting we go in a circle giving our name and a little bit about our coding background. This meant that we were able to determine our strengths and weaknesses. Agile would suggest that we are to build our projects around the strengths and motivations of our team members. Giving them an enviroment that they need and supporting them to get the job done. </p> 

<p>**I** was consistently trying to get in touch with our client, Grayson over this period. Regularly sending him emails with questions about what regular meeting times would work, or when we'd be able to come in and speak with him in person about the project. I tried to put an emphasis on this due to the principles of agile suggesting;</p>
...
<p>**According** to the 12 principles of Agile, our highest priority is to satisfy our customer through early and continuous delivery of valuable software. I really tried to keep that in mind this sprint, which meant keeping in constant contact with Grayson, letting him know everything we'd come up with and figuring out where his priorities are on the work.</p> 

<p>The last listed principle of Agile is probably the one that I find the easiest to forget about. Agile always seems to driven to meeting checkpoint to checkpoint that I find it really had to sit back and reflect on what has and hasn't work to make further work more effective. </p>
...
<p>Working software is the primary measure of progress. I was really worried this sprint that I wouldn't have anything to hand in at all, which would make three in a row that I missed out. I knew I couldn't start anything major, so instead I worked on bugs and appearances.</p> 

<p>My group has agreed that with our current living situations during the pandemic, it makes more sense to go for one week sprints. The thought process here being that it makes us more resilient down the line and we'll end up with more functional code submitted.</p>
...
<p>**"The** most efficient and effective method of conveying information to and within a development team is face-to-face conversation" Obviously going that far with things was out of the question at this point, so we had to chase after the next best thing. Given our current circumstances that turned out to be screenshare technology. It was insanely easy when you can actually show other people what you're working on to quickly get over issues that would otherwise have you completely stuck. </p> 

<p>**It** really became an issue this sprint of managing to get work into the customer, Grayson on time at a presentable level. There were things we'd be able to submit, of course, but they were just bits and pieces of code that were effectively useless by themselves. We opted not to show off the feature, instead waiting till it's fully functional. </p>
...
<p>A team has to be able to look into themselves. I genuinely believe that if team members are just left to succumb to other stresses it's inevitably going to hurt the team. Knowing one of my teammates hadn't done anything this sprint, I contacting them offering to go through some stuff with them in order for them to have something to submit. It doesn't matter how big or small each contribution is, as long as every team member is working it'll be alright. 

<p>**Pushing** ourselves too much here was a very real possibility. We had assignments in all other subjects really starting to stack up and the idea of jumping onto github and spending a couple hours trying to figure out some random bug was becoming less and less appealing. I think that the changes we made to our work load this sprint were a really good idea and also a real showing of just how flexible agile is.
...
<p>**Despite** working so hard on my feature for the website it ultimately wasn't on display when we presented to our customer as it was currently unfinished. This meant that I didn't exactly have much to talk about with Grayson, aside from a comment that I'm currently bug fixing a feature. I think that this was the best way to go about it. I don't want to try and submit something that can't function in as completed work. Something like that isn't suitable for the dev branch.

<p>Communication of what we're doing at any one time was pretty well done during this sprint. Everyone was in a mindset to just get it done and over with, so there was very little divergent thought. I was able to ask for assistance in real time with my teammates using slack.</p>

> ![alt text](https://i.imgur.com/936vwPo.png "Sharing my code on Slack")
...
<p>Some of the jobs we could have taken on were way too big to finish in that amount of time, especially considering since it was our last sprint we'd also need to clean up bug fixing. I think the focus that the only measure of success being functional active code we became aware that this sprint was more for polishing what does exist.</p>

<p>Testing really is something that just needs to be done constantly, I think I've found. Once you've written a single test it seems really easy to modify in the future ensuring it's longevity. It's not something I've really tried before, which makes it important. We're meant to be trying all different aspects of programming, so I'm glad I got to give this one a go.</p>

> ![alt text](https://i.imgur.com/bOalKTT.png "Relevent principle of agile")
